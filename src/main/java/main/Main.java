...
public class Main {
    public static void main(String[] args) {
        ...
        Weapon weapon = new Weapon(Weapon.material.Iron, Weapon.type.Sword, 10, 5); // PF 2
        ...
        System.out.println("\nSecond problem:");
        Weapon item1 = new Weapon(Weapon.material.Diamond, Weapon.type.Sword, 10, 4); // PF 2.5
        Weapon item2 = new Weapon(Weapon.material.Stone, Weapon.type.Axe, 10, 4); // PF 2.5
        Weapon item3 = new Weapon(Weapon.material.Netherite, Weapon.type.Pickaxe, 12, 6); // PF 2
